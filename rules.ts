...
export const hyperSubLayers: { [key_code in KeyCode]?: HyperSubLayerInput } = {
  ...
  q: {
    ...
    commands: {
      ...
      h: open("raycast://extensions/Codely/google-chrome/search-history", "Browser History"),
  ...
  o: {
    ...
    commands: {
      c: app("Calendar"),
      d: open("~/Documents", "Documents"),
      f: open("raycast://script-commands/new-finder-instance", "New Finder"),
      g: app("Ghostty"),
      k: open("'/Users/shay/github/karabiner/keyboard-shortcuts.pdf'", "Keyboard Shortcuts PDF"),
      p: open("~/Documents/payroll", "Payroll"),
